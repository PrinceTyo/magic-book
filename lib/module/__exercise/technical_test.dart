...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<int> input = [1, 2, 3, 4, 5];
      bool? output = input.join(",").contains("3");
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> input = ["apple", "banana", "cherry"];
      bool? output = input.join(",").contains("grape");
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      Map<String, int> output = {"number": 1};
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> input = ["apple", "banana", "cherry"];
      Map<String, String> output = {for (var item in input) item: item};
    ...
    () {
      ...
      Map<String, int> output = {"apple": input[0]["apple"]!};
    ...
    () {
      ...
      List<DateTime>? output;
      output = input.split(',').map((date) => DateTime.parse(date)).toList();
    ...
    () {
      ...
      String input = "apple,banana,cherry,dates,elderberry";
      Map<String, int>? output = {
        for (var word in input.split(",")) word: word.length
      };
    ...
    () {
      ...
      for (var pair in input.split(",")) {
        ...
        var fruit = parts[0]; // Nama buah
        var quantity = int.parse(parts[1]); // Jumlah, dikonversi ke integer
    ...
    () {
      ...
      for (var pair in input.split(",")) {
        var parts = pair.split(":");
        var fruit = parts[0]; // Nama buah
        var quantity = parts[1] == "true"; // Jumlah, dikonvers
        output[fruit] = quantity;
      }
    ...
    */
      ...
      name = text.substring(startIndex, endIndex).trim();
      return name == "Deny";
    },
    ...
    () {
      ...
      */
      numbers.sort();
      return numbers.first == 23 && numbers.last == 109;
    ...
    () {
      ...
      bool? output;
      if (input.toString().split('.')[1].length == 3) {
        output = true;
      } else {
        output = false;
      }
    ...
    () {
      ...
      bool output =
          input.toLowerCase() == input.toLowerCase().split('').reversed.join();
      return output == false;
    },
    ...
    () {
      ...
      bool output = input.runes.every((rune) => rune >= 48 && rune <= 57);
    ...
    () {
      ...
      bool output = input.toLowerCase().contains("dart");
      return output == true;
    },
    ...
    () {
      ...
      int output = numbers.fold(10, (sum, number) => sum + number);
      return output == 25;
    },
    ...
    () {
      ...
      List<int> output = numbers.where((number) => number.isOdd).toList();
    ...
    () {
      ...
      bool output = numbers.any((number) => number < 0);
      return output;
    },
    ...
    () {
      ...
      int output = numbers.reduce((curr, next) => curr > next ? curr : next);
      return output == 5;
    },
    ...
    () {
      ...
      String output = text.replaceAll("is", "will be");
    ...
    () {
      ...
      String output = text.substring(0, text.length - 4);
    ...
    () {
      ...
      int? output = text.split(RegExp("[aA]")).length - 1;
      return output == 2;
    },
...
// Exercise 333
    () {
      ...
      double? output = numbers[(numbers.length / 2).round() - 1].toDouble();
...
// Exercise 350
    ...
    () {
      ...
      bool allDivisibleBy3 =
          true; // Awalnya kita anggap semua angka bisa dibagi 3

      // Loop melalui semua angka dalam daftar
      for (int number in numbers) {
        if (number % 3 != 0) {
          // Cek apakah ada angka yang tidak habis dibagi 3
          allDivisibleBy3 = false;
          break; // Keluar dari loop jika menemukan angka yang tidak habis dibagi 3
        }
      }
    ...
    () {
      ...
      for (String fruit in fruits) {
        if (fruit == target) {
          ...
          break; // Exit the loop early since we've found the target
        }
      }
      // --- End of Answer ---
...
// Exercise 393
    () {
      List<Map<String, dynamic>> users = [
        {"id": 1, "name": "Alex", "age": 29},
        {"id": 2, "name": "David", "age": 31},
        {"id": 3, "name": "Siren", "age": 28, "address": "Ciawi street"},
      ];
      List<Map<String, dynamic>> filteredUsers = [];
...
// Exercise 395
    ...
    () {
      ...
      // Loop through each attendance record and count those who are present
    ...
    () {
      ...
      // Menggunakan loop for untuk menghitung total usia
      for (var employee in employees) {
    ...
    () {
      ...
      return maxPrice == 350000 &&
          minPrice == 150000; // Check if the max and min prices are correct
    },
    ...
    () {
      ...
      // Looping untuk mencari karyawan yang bekerja di departemen "IT"
      for (var employee in employees) {
      ...
      // Debug print untuk memastikan hasilnya
      print(itEmployees); // Pastikan list itEmployees berisi "Bob"
